...
class BasketJBUniversalController extends JBUniversalController
{
            ...
            if ($error) {
                ...
                if ((int)$appParams->get('global.jbzoo_cart_config.payment-enabled') && $orderDetails->getTotalPrice() > 0) {
					...
					echo 	"<script>(function() {
						...
						window._fbq.push(['track', '6027213688496', {'value':'0.00','currency':'RUB'}]);
						</script>";
						
					echo	'<noscript><img height="1" width="1" alt="" style="display:none" src="https://www.facebook.com/tr?ev=6027213688496&amp;cd[value]=0.00&amp;cd[currency]=RUB&amp;noscript=1" /></noscript>';
				
					echo 	'<script type="text/javascript">
							var _tmr = _tmr || [];
							_tmr.push({id: "2675040", type: "pageView", start: (new Date()).getTime()});
							(function (d, w, id) {
							...
							<img src="//top-fwz1.mail.ru/counter?id=2675040;js=na" style="border:0;" height="1" width="1" alt="Рейтинг@Mail.ru" />
							</div></noscript>';
					echo	'<script>_tmr.push({ id: "2675040", type: "reachGoal", goal: "NAME", value: VALUE });</script>';
    ...
    protected function _createEmptyItem($type, $application = null)
    {
        ...
        $item->access           = 2; // Joomla ViewLevel (Registered)
