...
<?php if ($vars['object']->alias == 'news-ru')
{
	jimport('joomla.application.module.helper');
	$module = &JModuleHelper::getModule('mod_zootag','tags-ru');
	echo JModuleHelper::renderModule($module);	
}
else if ($vars['object']->alias == 'news-en')
{
	jimport('joomla.application.module.helper');
	$module = &JModuleHelper::getModule('mod_zootag','tags-en');
	echo JModuleHelper::renderModule($module);
}
?>
