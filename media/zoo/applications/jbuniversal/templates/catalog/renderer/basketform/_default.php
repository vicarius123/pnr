...
?>
<h2 class="title-beforeOrderForom"><?php echo JText::_('JBZOO_CART_CREATE_ORDER_TITLE'); ?></h2>
    ...
    ?>
	 ...
	 <div class="submit-button">
        <input type="submit" name="submit" class="add-to-cart" style="display:inline-block;"
               value="<?php echo JText::_('JBZOO_CART_CREATE_ORDER'); ?>" ORDER>
    </div>

    <div class="required-info"><?php echo JText::_('JBZOO_CART_REQUIRED_INFO'); ?></div>
