...
if(!JFolder::exists(JPATH_SITE.DS.'media'.DS.'breezingforms'.DS.'themes')){
    JFile::write(JPATH_SITE.DS.'media'.DS.'breezingforms'.DS.'BFISNEW',$wpisnew);
    JFolder::copy(
...
if(!JFile::exists(JPATH_SITE.DS.'media'.DS.'breezingforms'.DS.'themes'.DS.'jq.mobile.1.4.min.css')){
    JFile::copy(
            JPATH_SITE.DS.'components'.DS.'com_breezingforms'.DS.'themes'.DS.'quickmode'.DS.'jq.mobile.1.4.min.css', 
            JPATH_SITE.DS.'media'.DS.'breezingforms'.DS.'themes'.DS.'jq.mobile.1.4.min.css'
    );
}

if(!JFile::exists(JPATH_SITE.DS.'media'.DS.'breezingforms'.DS.'themes'.DS.'jq.mobile.1.4.icons.min.css')){
    JFile::copy(
            JPATH_SITE.DS.'components'.DS.'com_breezingforms'.DS.'themes'.DS.'quickmode'.DS.'jq.mobile.1.4.icons.min.css', 
            JPATH_SITE.DS.'media'.DS.'breezingforms'.DS.'themes'.DS.'jq.mobile.1.4.icons.min.css'
    );
}
...
if(isset($tables[JFactory::getDBO()->getPrefix().'facileforms_forms'])){
    ...
    if(!isset( $tables[JFactory::getDBO()->getPrefix().'breezingforms'])){
    ...
    if(!isset( $tables[JFactory::getDBO()->getPrefix().'facileforms_forms']['tags_content'] )){
        JFactory::getDBO()->setQuery("ALTER TABLE `#__facileforms_forms` ADD `tags_content` text NOT NULL AFTER `dropbox_submission_types` ");
        JFactory::getDBO()->query();
    }
    if(!isset( $tables[JFactory::getDBO()->getPrefix().'facileforms_forms']['tags_content_template'] )){
    ...
    if(!isset( $tables[JFactory::getDBO()->getPrefix().'facileforms_forms']['tags_content_template_default_element'] )){
    ...
    if(!isset( $tables[JFactory::getDBO()->getPrefix().'facileforms_forms']['tags_content_default_category'] )){
    ...
    if(!isset( $tables[JFactory::getDBO()->getPrefix().'facileforms_forms']['tags_content_default_state'] )){
    ...
    if(!isset( $tables[JFactory::getDBO()->getPrefix().'facileforms_forms']['tags_content_default_access'] )){
    ...
    if(!isset( $tables[JFactory::getDBO()->getPrefix().'facileforms_forms']['tags_content_default_language'] )){
    ...
    if(!isset( $tables[JFactory::getDBO()->getPrefix().'facileforms_forms']['tags_content_default_featured'] )){
    ...
    if(!isset( $tables[JFactory::getDBO()->getPrefix().'facileforms_forms']['tags_content_default_publishup'] )){
    ...
    if(!isset( $tables[JFactory::getDBO()->getPrefix().'facileforms_forms']['tags_content_default_publishdown'] )){
    ...
    if(!isset( $tables[JFactory::getDBO()->getPrefix().'facileforms_forms']['tags_form'] )){
    ...
    if(!isset( $tables[JFactory::getDBO()->getPrefix().'facileforms_forms']['autoheight'] )){
        JFactory::getDBO()->setQuery("ALTER TABLE `#__facileforms_forms` ADD `autoheight` TINYINT( 1 ) NOT NULL DEFAULT 0 AFTER `tags_form` ");
        JFactory::getDBO()->query();
    }
    if(!isset( $tables[JFactory::getDBO()->getPrefix().'facileforms_forms']['filter_state'] )){
