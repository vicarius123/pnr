...
//		echo bf_alert('Custom languages in full version, only', 'http://crosstec.de/en/extensions/joomla-forms-download.html');
    ...
    <div style="display: none;" class="bfLanguageButton<?php echo $active_language_code == JFactory::getLanguage()->getDefault() || $active_language_code == '' ? ' bfLanguageButtonActive' : '' ?>">
    <?php echo JFactory::getLanguage()->getDefault(); ?>
    </div> 
    <?php
    ...
    ?>
    <div style="display: none;" class="bfLanguageButton<?php echo $active_language_code == $language->lang_code ? ' bfLanguageButtonActive' : '' ?>"><?php echo $language->lang_code; ?></div> 
            <?php
        }
    }
